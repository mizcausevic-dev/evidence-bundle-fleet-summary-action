...
export type FindingCode = "bundle-expired" | "unsigned-regulated-bundle" | "cross-bundle-hash-collision" | "oversized-bundle" | "no-provenance" | "no-items" | "no-relationships" | "no-labels";
...
export declare const REGULATED_PURPOSES: ReadonlySet<BundlePurpose>;
